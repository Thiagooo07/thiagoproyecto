...
@Component({
  selector: 'app-card-mochilas',
  templateUrl: './card-mochilas.component.html',
  styleUrls: ['./card-mochilas.component.css']
})
export class CardMochilasComponent {
 // Colección de todos los productos
 coleccionProductos: Producto[] = [];
 
 // Colección de sólo productos de categoría "Juguetes"
 coleccionMochilas: Producto[] = [];
 ...
 mostrarProductoindumentaria(){
   ...
   this.coleccionProductos.forEach(producto => {
     ...
     if(producto.categoria === "mochilas"){
       // .push: sube o agrega un item a una colección
       this.coleccionMochilas.push(producto);
     }
   })
 }
